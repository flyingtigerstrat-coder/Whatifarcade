...
TRIED: Playwright drove fresh boot (both orientations), market/board at home, the Noodle tap, depart-from-home, and the full linebroken loop from THE TERMINUS back to a docked, lit Railhead. Harness grew to 124 assertions (home-station laws included); THE RAILHEAD render stays byte-identical; exporter regression clean.
